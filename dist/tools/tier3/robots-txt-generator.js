...
function validateRobotsTxt(content) {
    ...
    for (let i = 0; i < lines.length; i++) {
        ...
        if (line === "" || line.startsWith("#"))
            continue;
        const isValidDirective = VALID_DIRECTIVES.some((d) => line.startsWith(d));
        if (!isValidDirective) {
...
export function handleGenerateRobotsTxt(input) {
    const issues = [];
...
//# sourceMappingURL=robots-txt-generator.js.map