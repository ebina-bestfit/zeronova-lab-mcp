 ...
 */
function isValidChangefreq(value) {
    return VALID_CHANGEFREQ.includes(value);
}
/**
...
export function handleGenerateSitemapXml(input) {
    const issues = [];
    ...
    const isValid = content.includes('<?xml version="1.0"') &&
...
//# sourceMappingURL=sitemap-xml-generator.js.map